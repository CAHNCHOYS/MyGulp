...
import  { fontsStyle, ttfTowoff2, otf2woff, wathchSvgFonts} from  './gulp/tasks/fonts.js'
...
const mainTasks = gulp.series(fonts, gulp.parallel(jsTasks, html, scss, copy, images )) ;
